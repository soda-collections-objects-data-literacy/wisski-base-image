...
if [ -f "$SETTINGS_FILE" ]; then
  ...
  echo -e "\033[0;33mINSTALL DEVELOPMENT MODULES.\033[0m"
  {
    ...
    composer require soda-collection-objects-data-literacy/soda_wisski_sso_bouncer:main --prefer-source
  ...
  drush wisski-core:import-ontology --store="default" --ontology_url="http://scs.sammlungen.io/ontology/base_record/current/" --reasoning
